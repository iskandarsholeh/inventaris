...
?>
<h3><span class="glyphicon glyphicon-LIST"></span>  Data Jenis</h3>
 <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Jenis</button>
 <body>
	<?php 
$per_hal=5;
$jumlah_record=mysql_query("SELECT COUNT(*) from jenis");
...
<div class="col-md-12">
 ...
 <form action="cari_jenis.php" method="get">
 ...
 <?php 
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from jenis where nama_jenis like '$cari%'");
	}else{
		$brg=mysql_query("select * from jenis limit $start, $per_hal");
	}
	$no=1;
	while($data=mysql_fetch_array($brg)){
		...
		?>
                      ...
                      <td class="center"><a href="edit_jenis.php?id=<?php echo $data['id_jenis']; ?>" class="btn btn-warning" > Edit </a>
					  <a href="hapus_jenis.php?id=<?php echo $data['id_jenis']; ?>" 
