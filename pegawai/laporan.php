...
<head>
 <?php 
$per_hal=5;
$jumlah_record=mysql_query("SELECT COUNT(*) from view_pinjam");
...
<table class="table table-bordered table-striped table-hover" >
 ...
 <?php 
  if(isset($_GET['cari'])){
    ...
    $brg=mysql_query("select * from view_pinjam where nama_pegawai like '$cari%' ");
  }else{
    $brg=mysql_query("select * from view_pinjam limit $start, $per_hal");
  }
  $no=1;
  while($data=mysql_fetch_array($brg)){
    ...
    ?>    
              ...
              <td ><?php echo $data['status_peminjaman'];?></td>
                                             ...
                                             <td class="center"><a class="btn btn-warning" href="detail_pinjam.php?id=<?php echo $data['id_detail_pinjam']; ?>"> Detail</a>
...
<form name="LPbarang" method="GET" action="viewlaporan.php">
<table align="center">
