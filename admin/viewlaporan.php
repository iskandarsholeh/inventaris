...
include "header.php";
?> 
    <a style="margin-bottom:10px" href="lap_bulan1.php"  target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
     ...
     <table class="table table-bordered table-striped table-hover">
		    ...
		    <?php
		      include '../db/koneksi.php'; 
		    	$no=1;
		    	$sql=mysql_query("SELECT * FROM view_pinjam WHERE MONTH(tanggal_pinjam)=$bulan AND YEAR(tanggal_pinjam)=$tahun");
