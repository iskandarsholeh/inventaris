...
?> 
     ...
     <h3 align="center">Laporan Inventaris Pinjam</h3>
      ...
      <a style="margin-bottom:10px" href="lap_out_bulan.php?Bulan=<?php echo $bulan; ?>&Tahun=<?php echo $tahun; ?>" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
     ...
     <table class="table table-bordered table-striped table-hover">
			<tr >
				...
				<th style="text-align: center">Tanggal Out</th>
				<th style="text-align: center">Waktu Out</th>
		    ...
		    <?php
		      include '../db/koneksi.php'; 
		    	$no=1;
		    	$sql=mysql_query("SELECT * FROM view_jual WHERE MONTH(tanggal_out)=$bulan AND YEAR(tanggal_out)=$tahun");
		    	while ($row=mysql_fetch_array($sql)) {
		     ?>
		    <tr>
				<th scope="row" style="padding: 5px"><center><?= $no++; ?></center></th>
				<td  align="center"><?= $row['nama']; ?></td>
				<td  align="center"><?= $row['tanggal_out']; ?></td>
				<td  align="center"><?= $row['waktu_out']; ?></td>
				<td  align="center"><?= $row['jumlah_out']; ?></td>
				<td  align="center"><?= $row['status_out']; ?></td>
