...
$pdf->Cell(3, 0.8, 'Tanggal jual', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'Waktu jual', 1, 0, 'C');
$pdf->Cell(2, 0.8, 'Jenis', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Nama Karyawan', 1, 0, 'C');
$pdf->Cell(2, 0.8, 'jumlah', 1, 1, 'C');
$pdf->SetFont('Arial','',10);
$no=1;
$query=mysql_query("select * from detail_bout,bout,inventaris,pegawai,jenis
where bout.id_pegawai = pegawai.id_pegawai and
detail_bout.id_inventaris = inventaris.id_inventaris and bout.status_out= 'terjual' and 
detail_bout.id_out = bout.id_out and jenis.id_jenis = inventaris.id_jenis
order by id_detail_out");
