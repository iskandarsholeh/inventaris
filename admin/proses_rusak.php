...
echo "<script>alert('Stock Barang Kurang !! :)');</script>";
	...
	$query=mysql_query("INSERT INTO bout (tanggal_out,tanggal_ganti,waktu_out,id_pegawai,status_out,waktu_ganti) VALUES('$tp','0000-00-00','$wp','$idpegawai','dikembalikan','00:00:00') ");
