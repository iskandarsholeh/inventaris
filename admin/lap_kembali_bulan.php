...
$pdf->Cell(25.5,0.7,"Laporan Data Barang yang sudah Kembali",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$no=1;
$query=mysql_query("SELECT * FROM view_kembali WHERE MONTH(tanggal_pinjam)=$bulan AND YEAR(tanggal_pinjam)=$tahun");
